...
public class ParkingLot {
    ...
    public void park(String regNo, String color) {
        if (color == "")
            System.out.println("Please insert color");
        if (this.MAX_SIZE == 0) {
        ...
        if (this.MAX_SIZE == 0) {
            ...
            if (carToLeave != null) {
                ...
                if ( Integer.parseInt(Hour)  <= 2) {
                 ...
                 double AddHour = Integer.parseInt(Hour) - 2;
                 double AddPrice = AddHour * 10;
                 Price = AddPrice + 10;
                }

                System.out.println("Slot number " + slotNo + " is free With Charge $" + Price);
                System.out.println();
            } else {
